...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "Büchel Brand Boost is a website for Restaurant Büchel, enhancing user experience and AI discoverability." },
      { property: "og:description", content: "Büchel Brand Boost is a website for Restaurant Büchel, enhancing user experience and AI discoverability." },
      { name: "twitter:description", content: "Büchel Brand Boost is a website for Restaurant Büchel, enhancing user experience and AI discoverability." },
      { property: "og:image", content: "https://pub-bb2e103a32db4e198524a2e9ed8f35b4.r2.dev/67fe6e76-fbd8-42ad-bf0e-35a5d62877b5/id-preview-7837bb41--39eacb9f-988d-46c0-829f-ec4d5aa69157.lovable.app-1781805994127.png" },
      { name: "twitter:image", content: "https://pub-bb2e103a32db4e198524a2e9ed8f35b4.r2.dev/67fe6e76-fbd8-42ad-bf0e-35a5d62877b5/id-preview-7837bb41--39eacb9f-988d-46c0-829f-ec4d5aa69157.lovable.app-1781805994127.png" },
    ],
    links: [
